...
//
//     final googleDirectionsModel = googleDirectionsModelFromJson(jsonString);

import 'dart:convert';

GoogleDirectionsModel googleDirectionsModelFromJson(String str) => GoogleDirectionsModel.fromJson(json.decode(str));

String googleDirectionsModelToJson(GoogleDirectionsModel data) => json.encode(data.toJson());

class GoogleDirectionsModel {
  GoogleDirectionsModel({
  ...
  factory GoogleDirectionsModel.fromJson(Map<String, dynamic> json) => GoogleDirectionsModel(
